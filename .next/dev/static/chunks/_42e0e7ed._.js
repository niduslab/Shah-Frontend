...
"[project]/lib/components/CountdownTimer.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
'use client';
;
function CountdownTimer({ initialSeconds = 300, onExpire, onResend }) {
    _s();
        ...
        "CountdownTimer.useEffect": ()=>{
            ...
            const timer = setInterval({
                "CountdownTimer.useEffect.timer": ()=>{
                    setSeconds({
                        "CountdownTimer.useEffect.timer": (prev)=>prev - 1
                    }["CountdownTimer.useEffect.timer"]);
                }
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: !isExpired ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
            className: "text-sm text-muted-foreground",
            children: [
                "Code expires in: ",
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                    className: "font-semibold text-[#0B3B2D]",
                    children: formatTime(seconds)
                }, void 0, false, {
                    fileName: "[project]/lib/components/CountdownTimer.tsx",
                    lineNumber: 49,
                    columnNumber: 28
                }, this)
            ]
...
_s(CountdownTimer, "mVRlZcyi8Dz7P84BlQ8E4dL5nHw=");
_c = CountdownTimer;
var _c;
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$components$2f$CountdownTimer$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/components/CountdownTimer.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
'use client';
;
...
function ForgotPasswordPage() {
    _s();
    const [step, setStep] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(1); // 1: Email, 2: Verify OTP, 3: New Password, 4: Success
    ...
    const handleSendOtp = async (e)=>{
        ...
        setLoading(true);
        try {
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$otpAuthService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["otpAuthService"].sendOtp(email);
            if (data.success) {
    ...
    const handleVerifyOtp = async (e)=>{
        ...
        setLoading(true);
        try {
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$otpAuthService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["otpAuthService"].verifyOtp(email, otp);
            if (data.success) {
                setMessage(data.message);
            ...
            const errorMessage = err.response?.data?.message || err.response?.data?.error || 'Invalid or expired OTP. Please try again.';
            setError(errorMessage);
        } finally{
            setLoading(false);
        }
    ...
    const handleResetPassword = async (e)=>{
        ...
        setLoading(true);
        try {
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$otpAuthService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["otpAuthService"].resetPassword(email, otp, password, passwordConfirmation);
            if (data.success) {
                setMessage(data.message);
    ...
    const handleResendOtp = async ()=>{
        ...
        try {
            ...
            const errorMessage = err.response?.data?.message || err.response?.data?.error || 'Failed to resend OTP. Please try again.';
            setError(errorMessage);
        } finally{
            setLoading(false);
        }
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                href: "/login",
                                className: "font-medium text-[#0B3B2D] hover:underline",
            ...
            step === 2 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                children: [
                    ...
                    message && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "p-4 rounded-lg bg-green-50 border border-green-200 text-green-600 text-sm",
                        children: message
                    }, void 0, false, {
                        fileName: "[project]/app/(auth)/forgot-password/page.tsx",
                        lineNumber: 241,
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$components$2f$CountdownTimer$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                initialSeconds: 300,
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                ...
                                                className: "absolute right-4 top-1/2 -translate-y-1/2 text-gray-500 hover:text-gray-700",
                                                children: showPasswordConfirmation ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("svg", {
                                                    className: "w-5 h-5",
                                                    fill: "none",
                                                    stroke: "currentColor",
                                                    viewBox: "0 0 24 24",
...
_s(ForgotPasswordPage, "tYD7/nD2E/8ZtC4hSxEcTsemZRk=", false, function() {
    return [
...
//# sourceMappingURL=_42e0e7ed._.js.map