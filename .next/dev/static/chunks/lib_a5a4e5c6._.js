...
api.interceptors.response.use((response)=>response, async (error)=>{
    ...
    if (error.response?.status === 419 && !originalRequest._retry) {
        ...
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${API_URL}/sanctum/csrf-cookie`, {
                withCredentials: true
            });
...
const authService = {
    ...
    async register (data) {
        ...
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/api/auth/register', data);
    ...
    async login (email, password) {
        ...
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/api/auth/login', {
            email,
            password
        });
        return response.data;
    ...
    async logout () {
        try {
            ...
            await this.getCsrfCookie();
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/api/auth/logout');
            return response.data;
        } catch (error) {
    ...
    async getUser () {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('/api/auth/user');
        return response.data;
    },
    // Update profile
    async updateProfile (data) {
        await this.getCsrfCookie();
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put('/api/auth/profile', data);
        return response.data;
    },
    // Change password
    async changePassword (data) {
        await this.getCsrfCookie();
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2f$axios$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put('/api/auth/password', data);
        return response.data;
    }
};
...
const AuthProvider = ({ children })=>{
    ...
    const logout = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[logout]": async ()=>{
            try {
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$authService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].logout();
            } catch (error) {
    ...
    const checkAuth = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[checkAuth]": async (showLoading = true)=>{
            if (showLoading) setLoading(true);
            try {
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$authService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].getUser();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthProvider.useEffect": ()=>{
            const intervalId = setInterval({
                "AuthProvider.useEffect.intervalId": ()=>{
                    if (userRef.current) {
                        checkAuth(false);
                    }
                }
            }["AuthProvider.useEffect.intervalId"], 5 * 60 * 1000);
            return ({
                "AuthProvider.useEffect": ()=>clearInterval(intervalId)
            })["AuthProvider.useEffect"];
        }
    }["AuthProvider.useEffect"], [
        checkAuth
    ...
    const login = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[login]": async (email, password)=>{
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$authService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].login(email, password);
    ...
    const register = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[register]": async (data)=>{
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$authService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].register(data);
            setUser(response.data.user);
            return response;
        }
...
_s(AuthProvider, "yeXbvIKyaDChLtKgNheHpYClqa0=");
_c = AuthProvider;
const useAuth = ()=>{
    _s1();
...
"[project]/lib/context/CartContext.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const CartProvider = ({ children })=>{
    ...
    const addToCart = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "CartProvider.useCallback[addToCart]": (item, redirectUrl)=>{
            ...
            setItems({
                "CartProvider.useCallback[addToCart]": (prevItems)=>{
                    const existingItemIndex = prevItems.findIndex({
                        "CartProvider.useCallback[addToCart].existingItemIndex": (i)=>i.product_id === item.product_id && i.variation_id === item.variation_id
                    ...
                    if (existingItemIndex > -1) {
                        ...
                        setTimeout({
                            "CartProvider.useCallback[addToCart]": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success('Cart updated successfully')
                        }["CartProvider.useCallback[addToCart]"], 0);
                    } else {
                        // Add new item
                        result = [
                            ...prevItems,
                        ...
                        setTimeout({
                            "CartProvider.useCallback[addToCart]": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success('Product added to cart')
                        }["CartProvider.useCallback[addToCart]"], 0);
                    }
                    return result;
                }
            ...
            setTimeout({
                "CartProvider.useCallback[addToCart]": ()=>setIsProcessing(false)
            }["CartProvider.useCallback[addToCart]"], 300);
        }
    }["CartProvider.useCallback[addToCart]"], [
        isProcessing
    ]);
    const removeFromCart = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "CartProvider.useCallback[removeFromCart]": (productId, variationId)=>{
            setItems({
                "CartProvider.useCallback[removeFromCart]": (prevItems)=>prevItems.filter({
                        "CartProvider.useCallback[removeFromCart]": (item)=>!(item.product_id === productId && item.variation_id === variationId)
    ...
    const updateQuantity = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "CartProvider.useCallback[updateQuantity]": (productId, quantity, variationId)=>{
            if (quantity < 1) {
            ...
            setItems({
                "CartProvider.useCallback[updateQuantity]": (prevItems)=>prevItems.map({
                        "CartProvider.useCallback[updateQuantity]": (item)=>item.product_id === productId && item.variation_id === variationId ? {
                                ...item,
                                quantity
                            } : item
    ...
    const setAppliedCoupon = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "CartProvider.useCallback[setAppliedCoupon]": (coupon)=>{
            setAppliedCouponState(coupon);
        }
    }["CartProvider.useCallback[setAppliedCoupon]"], []);
    const getCartCount = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "CartProvider.useCallback[getCartCount]": ()=>{
            return items.reduce({
                "CartProvider.useCallback[getCartCount]": (total, item)=>total + item.quantity
    ...
    const isInCart = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "CartProvider.useCallback[isInCart]": (productId, variationId)=>{
            return items.some({
                "CartProvider.useCallback[isInCart]": (item)=>item.product_id === productId && item.variation_id === variationId
            }["CartProvider.useCallback[isInCart]"]);
        }
    }["CartProvider.useCallback[isInCart]"], [
        items
    ]);
...
_s(CartProvider, "nmCRFMaZ7bnrYdJNuK2ptULNEwg=");
_c = CartProvider;
const useCart = ()=>{
    _s1();
...
"[project]/lib/providers/QueryProvider.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
_s(QueryProvider, "qNdzo59TCUeyBTXRWK0ir0mYoQU=");
_c = QueryProvider;
var _c;
...
"[project]/lib/components/ToastProvider.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=lib_a5a4e5c6._.js.map