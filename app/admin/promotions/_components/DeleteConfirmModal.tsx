      ...
      <div className="relative w-full max-w-md rounded-2xl bg-white shadow-2xl">
        ...
        <div className="p-6">
          <p className="text-gray-600 mb-4">
            ...
            <span className="font-bold font-mono text-gray-900">{promotionName}</span>?
          </p>
          <div className="rounded-lg bg-red-50 border border-red-200 p-4">
            <p className="text-sm text-red-800">
              This action cannot be undone. All usage history for this promotion will be preserved, but the promotion will no longer be usable.
            </p>
          </div>
        </div>
