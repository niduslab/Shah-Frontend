...
import { Plus, Edit2, Trash2, Search, FileText, Eye, EyeOff, Layers, ArrowLeft } from 'lucide-react';
...
export default function PagesManagementPage() {
  ...
  const handleEdit = (page: Page) => {
    router.push(`/admin/pages/${page.id}/sections`);
  };
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Manage Pages</h1>
              <p className="text-sm text-gray-600">View and manage all your pages</p>
            </div>
          </div>
        </div>
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4">
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {(page.sections_count !== undefined || (page as any).sections) && (
                          <span className="inline-flex items-center gap-1.5 rounded-full bg-blue-100 px-2.5 py-0.5 text-xs font-medium text-blue-700">
                            ...
                            {page.sections_count ?? (page as any).sections?.length ?? 0} Sections
                          </span>
                        )}
                      </div>
                    </div>
