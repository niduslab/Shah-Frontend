...
export default function DeleteConfirmModal({ isOpen, onClose, onConfirm, userName, isLoading }: DeleteConfirmModalProps) {
      ...
      <div className="relative w-full max-w-md bg-white rounded-2xl shadow-2xl">
        <div className="flex items-center justify-between border-b border-gray-200 px-6 py-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">Permanently remove this user</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-6 space-y-4">
            ...
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-red-800">
                  This action cannot be undone. All user data, including orders, reviews, and account information will be permanently deleted.
                </p>
              </div>
            </div>
          </div>
          ...
          <p className="text-sm text-gray-600">
            Are you sure you want to delete <span className="font-semibold text-gray-900">{userName}</span>? This will remove all associated data from the system.
          </p>
        </div>
