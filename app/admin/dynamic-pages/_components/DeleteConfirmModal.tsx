      ...
      <div className="w-full max-w-md rounded-2xl bg-white shadow-2xl">
        ...
        <div className="p-6">
          <p className="text-sm text-gray-600">
            Are you sure you want to delete <span className="font-semibold text-gray-900">"{pageTitle}"</span>?
          </p>
          <p className="mt-2 text-sm text-red-600">
            This will also delete all sections and content associated with this page. This action cannot be undone.
          </p>
        </div>
