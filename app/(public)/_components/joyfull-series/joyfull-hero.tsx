...
export default function JoyfullHero() {
  const handleWhatsAppClick = () => {
    const message = encodeURIComponent("Hi, I'm interested in the Joyfull Series flooring. Can you provide more details?");
      ...
      <div className="container mx-auto max-w-[1400px] px-6 md:px-12 relative z-10">
        <div className="max-w-3xl">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white leading-tight mb-6">
            Joyfull Series{' '}
            <span className="text-yellow-400">Indoor Sports Flooring</span>
          </h1>
          
          <p className="text-base md:text-lg text-gray-200 mb-8 max-w-2xl leading-relaxed">
            High-performance indoor sports flooring built to international standards. Engineered for table tennis, badminton, basketball, and multipurpose courts with superior durability and performance.
          </p>
