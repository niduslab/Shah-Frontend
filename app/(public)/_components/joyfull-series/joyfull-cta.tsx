...
export default function JoyfullCTA() {
  const handleWhatsAppClick = () => {
    const message = encodeURIComponent("Hi, I'm interested in the Joyfull Series flooring. Can you provide more information?");
  ...
  return (
    <section className="relative py-16 md:py-24 overflow-hidden bg-black">
      <Image
        ...
        alt="Contact us for Joyfull Series"
        fill
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-white">
              Ready to Install{' '}
              <span className="text-[#ffb81e]">Joyfull Series?</span>
            </h2>
            
            <p className="text-base text-gray-300 mb-8 max-w-2xl mx-auto leading-relaxed">
              Contact our team today to get a free quote and professional consultation for your sports facility.
            </p>
