...
export default function FlooringSolutionCTA() {
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-white">
              ...
              <span className="text-[#ffb81e]">Sports Facility?</span>
            </h2>
            
            <p className="text-base text-gray-300 mb-8 max-w-2xl mx-auto leading-relaxed">
              Our expert team is ready to help you choose and install the perfect high-performance flooring solution tailored to your specific needs.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center p-6 rounded-sm bg-white/5 border border-white/10 backdrop-blur-sm">
              ...
              <div className="text-gray-400 text-sm font-medium">Quality Guaranteed</div>
            </div>
            <div className="text-center p-6 rounded-sm bg-white/5 border border-white/10 backdrop-blur-sm">
