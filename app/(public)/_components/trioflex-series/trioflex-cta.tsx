...
export default function TrioflexCTA() {
  const handleWhatsAppClick = () => {
    const message = encodeURIComponent("Hi, I'm interested in the Trioflex Series flooring. Can you provide more information?");
  ...
  return (
    <section className="relative py-16 md:py-24 overflow-hidden bg-black">
      <Image
        ...
        alt="Contact us for Trioflex Series"
        fill
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-white">
              Ready to Install{' '}
              <span className="text-[#ffb81e]">Trioflex Series?</span>
            </h2>
