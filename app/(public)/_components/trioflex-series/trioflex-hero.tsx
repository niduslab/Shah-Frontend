...
export default function TrioflexHero() {
  const handleWhatsAppClick = () => {
    const message = encodeURIComponent("Hi, I'm interested in the Trioflex Series flooring. Can you provide more details?");
      ...
      <div className="container mx-auto max-w-[1400px] px-6 md:px-12 relative z-10">
        <div className="max-w-3xl">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white leading-tight mb-6">
            Trioflex Series{' '}
            <span className="text-yellow-400">Premium Indoor Sports Flooring</span>
          </h1>
          
          <p className="text-base md:text-lg text-gray-200 mb-8 max-w-2xl leading-relaxed">
            High-end line of indoor sports flooring purpose built to meet the requirement of high performance indoor sports flooring. ITTF approved for professional table tennis and competitive sports.
          </p>
