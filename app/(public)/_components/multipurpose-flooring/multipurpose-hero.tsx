...
export default function MultipurposeHero() {
  const handleWhatsAppClick = () => {
    const message = encodeURIComponent("Hi, I'm interested in your multipurpose flooring solutions. Can you provide more details?");
  ...
  return (
    <section className="relative min-h-[500px] md:min-h-[600px] flex items-center overflow-hidden bg-black py-20 md:py-32">
      <Image
        ...
        alt="Multipurpose Sports Flooring"
        fill
        priority
