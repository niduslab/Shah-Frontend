...
export default function MultipurposeCTA() {
  const handleWhatsAppClick = () => {
    const message = encodeURIComponent("Hi, I'm interested in your multipurpose flooring solutions. Can you provide more information?");
  ...
  return (
    <section className="relative py-16 md:py-24 overflow-hidden bg-black">
      <Image
        ...
        alt="Contact us for multipurpose flooring"
        fill
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-white">
              Ready to Install{' '}
              <span className="text-[#ffb81e]">Multipurpose Flooring?</span>
            </h2>
            
            <p className="text-base text-gray-300 mb-8 max-w-2xl mx-auto leading-relaxed">
              Contact our team today to get a free quote and professional consultation for your facility.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center p-6 rounded-sm bg-white/5 border border-white/10 backdrop-blur-sm">
              ...
              <div className="text-gray-400 text-sm font-medium">Versatile Design</div>
            </div>
            <div className="text-center p-6 rounded-sm bg-white/5 border border-white/10 backdrop-blur-sm">
