...
export function ProductAccordions({ product }: ProductAccordionsProps) {
  ...
  const sections = [
    ...
    },
    {
      ...
      content: product.shipping_notes || "Shipping charges are calculated at checkout based on your delivery method and location. We offer a 30-day money-back guarantee on all products. If you are not satisfied with your purchase, you can return it for a full refund within 30 days of delivery. Return shipping costs may apply.",
      isHtml: false
    }
  ];
