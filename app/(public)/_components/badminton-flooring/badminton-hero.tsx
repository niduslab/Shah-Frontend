...
export default function BadmintonHero() {
  const handleWhatsAppClick = () => {
    const message = encodeURIComponent("Hi, I'm interested in your professional badminton flooring. Can you provide more details?");
  ...
  return (
    <section className="relative min-h-[500px] md:min-h-[600px] flex items-center overflow-hidden bg-black py-20 md:py-32">
      <Image
        src="/images/flooring-solution-page/joyfull/badminton/Screenshot 2026-03-31 125015.png"
        alt="Professional Badminton Flooring"
        fill
        priority
      ...
      <div className="container mx-auto max-w-[1400px] px-6 md:px-12 relative z-10">
        <div className="max-w-3xl">
          ...
          <p className="text-base md:text-lg text-gray-200 mb-8 max-w-2xl leading-relaxed">
            High-performance badminton flooring engineered for superior traction, durability, and player comfort. Perfect for competitive tournaments and recreational facilities.
          </p>
