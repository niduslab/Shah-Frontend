...
const specifications = [
  {
    ...
    items: ['Glaze+ Surface Treatment', 'Enhanced grip characteristics', 'Professional finish'],
  },
  {
    title: 'Construction',
  ...
  {
    title: 'Performance',
    items: ['Higher coefficient of friction', 'Good grip to avoid skidding', 'Superior shock absorption'],
  },
  {
    title: 'Durability',
...
export default function BadmintonSpecifications() {
  return (
      ...
      <div className="container mx-auto max-w-[1400px] px-6 md:px-12">
        <div className="text-center mb-12">
          ...
          <p className="text-base text-gray-600 max-w-2xl mx-auto leading-relaxed">
            Comprehensive details about our badminton flooring specifications and features.
          </p>
        </div>
