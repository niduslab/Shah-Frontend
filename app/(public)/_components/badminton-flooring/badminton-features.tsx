...
const features = [
  ...
  },
  {
    ...
    description: 'Meets all standards for professional badminton competition.',
  },
];

export default function BadmintonFeatures() {
  return (
      ...
      <div className="container mx-auto max-w-[1400px] px-6 md:px-12">
        <div className="text-center mb-12">
          ...
          <p className="text-base text-gray-600 max-w-2xl mx-auto leading-relaxed">
            Our badminton flooring features cutting-edge technology for professional performance.
          </p>
        </div>
