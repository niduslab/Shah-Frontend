...
export default function BadmintonCTA() {
  const handleWhatsAppClick = () => {
    const message = encodeURIComponent("Hi, I'm interested in your professional badminton flooring. Can you provide more information?");
  ...
  return (
    <section className="relative py-16 md:py-24 overflow-hidden bg-black">
      <Image
        ...
        alt="Contact us for badminton flooring"
        fill
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-white">
              ...
              <span className="text-[#ffb81e]">Badminton Flooring?</span>
            </h2>
            
            <p className="text-base text-gray-300 mb-8 max-w-2xl mx-auto leading-relaxed">
              Contact our team today to get a free quote and professional consultation for your badminton facility.
            </p>
