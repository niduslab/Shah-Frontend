...
export default function BasketballCTA() {
  const handleWhatsAppClick = () => {
    const message = encodeURIComponent("Hi, I'm interested in your professional basketball flooring. Can you provide more information?");
  ...
  return (
    <section className="relative py-16 md:py-24 overflow-hidden bg-black">
      <Image
        ...
        alt="Contact us for basketball flooring"
        fill
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-white">
              ...
              <span className="text-[#ffb81e]">Basketball Flooring?</span>
            </h2>
            
            <p className="text-base text-gray-300 mb-8 max-w-2xl mx-auto leading-relaxed">
              Contact our team today to get a free quote and professional consultation for your basketball facility.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center p-6 rounded-sm bg-white/5 border border-white/10 backdrop-blur-sm">
              ...
              <div className="text-gray-400 text-sm font-medium">Professional Grade</div>
            </div>
            <div className="text-center p-6 rounded-sm bg-white/5 border border-white/10 backdrop-blur-sm">
