...
const specifications = [
  ...
  {
    title: 'Performance',
    items: ['Ball rebound rate > 90%', 'Good shock absorption', 'Superior protection'],
  },
  {
    title: 'Durability',
...
export default function BasketballSpecifications() {
  return (
      ...
      <div className="container mx-auto max-w-[1400px] px-6 md:px-12">
        <div className="text-center mb-12">
          ...
          <p className="text-base text-gray-600 max-w-2xl mx-auto leading-relaxed">
            Comprehensive details about our basketball flooring specifications and features.
          </p>
        </div>
