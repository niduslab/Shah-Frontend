...
export default function TableTennisHero() {
  const handleWhatsAppClick = () => {
    const message = encodeURIComponent("Hi, I'm interested in your ITTF certified table tennis flooring. Can you provide more details?");
  ...
  return (
    <section className="relative min-h-[500px] md:min-h-[600px] flex items-center overflow-hidden bg-black py-20 md:py-32">
      <Image
        ...
        alt="ITTF Certified Table Tennis Flooring"
        fill
        priority
      ...
      <div className="container mx-auto max-w-[1400px] px-6 md:px-12 relative z-10">
        <div className="max-w-3xl">
          ...
          <p className="text-base md:text-lg text-gray-200 mb-8 max-w-2xl leading-relaxed">
            ITTF certified table tennis flooring engineered for superior grip, optimal ball bounce, and exceptional player comfort. Perfect for professional tournaments and training facilities.
          </p>
